class Constants {
    static get PLAYER_SPAWN_X() {
        return 75;
    }

    static get PLAYER_SPAWN_Y() {
        return 75;
    }
...
class Assets {
    static get SPRITESHEET_CHARACTERS() {
        return '../assets/characters/sprites-character.png';
    }

    static get SPRITESHEET_CHARACTERS_JSON() {
        return '../assets/characters/sprites-character.json';
    }

    static get TILES() {
        return '../assets/tiles/tileset.png';
    }

    static get TILES_JSON() {
        return '../assets/tiles/tilemap.json';
    }
}
